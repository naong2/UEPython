...
class SwitchboardDialog(QtCore.QObject):
    ...
    def __init__(self):
        ...
        # naong2
        self.window.mu_auto_join_check_box2.stateChanged.connect(self.auto_join_checkbox)
        self.window.mu_auto_join_check_box2.setChecked(CONFIG.MUSERVER_AUTO_JOIN)
        self.window.mu_auto_launch_check_box.stateChanged.connect(self.auto_launch_checkbox)
        self.window.mu_auto_launch_check_box.setChecked(CONFIG.MUSERVER_AUTO_LAUNCH)
    ...
    # custom EGK
    def auto_join_checkbox(self, value):
        if CONFIG.MUSERVER_AUTO_JOIN != value:
            CONFIG.MUSERVER_AUTO_JOIN = value
            CONFIG.save()

    # custom EGK
    def auto_launch_checkbox(self, value):
        if CONFIG.MUSERVER_AUTO_LAUNCH != value:
            CONFIG.MUSERVER_AUTO_LAUNCH = value
            CONFIG.save()
